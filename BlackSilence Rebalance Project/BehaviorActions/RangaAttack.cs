...
public class BehaviourAction_RangaAttack_md5488 : BehaviourActionBase
{
        ...
        ref RencounterManager.ActionAfterBehaviour opponent)
    {
        ...
        var movingAction2 =
            new RencounterManager.MovingAction(ActionDetail.S7, CharMoveState.MoveForward, 30f, false, 0.9f);
